...
module.exports = async function (context, req) {
    ...
    try {
        ...
        const fromPayload =
            (typeof cp.targetRepo === "string" && cp.targetRepo) ||
            (typeof cp.repoSlug === "string" && cp.repoSlug) ||
            "";
        let repoSlug =
            fromPayload ||
        ...
        context.log &&
            context.log(
                `[submit-analysis-dispatch] Dispatching event '${body.event_type}' to repo '${repoSlug}'`,
            );
        ...
        if (!body.event_type || !body.client_payload) {
            context.res = {
                status: 400,
                headers,
                body: { error: "Missing event_type or client_payload" },
            };
            return;
        }
        ...
        const debugHeaders = {
            ...headers,
            "x-template-doctor-repo-slug": repoSlug,
        };
