...
test.describe('Global availability regression', () => {
  test('TemplateDoctorApiClient & TemplateDoctorIssueService become available', async ({ page }) => {
    await page.goto('/');
    await page.waitForFunction(() => !!(window.TemplateDoctorApiClient && window.TemplateDoctorIssueService), { timeout: 5000 });
