...
export interface QueuedAnalysis { args: any }
...
function maybeShowMessage(){
  ...
  div.style.cssText = 'position:fixed;bottom:20px;right:20px;z-index:9999;padding:15px 20px;border-radius:5px;box-shadow:0 2px 8px rgba(0,0,0,0.2);';
  div.innerHTML = `
