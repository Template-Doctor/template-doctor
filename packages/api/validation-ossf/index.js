...
module.exports = async function (context, req) {
    ...
    try {
        ...
        if (!templateUrl) {
            context.res = {
                ...
                body: {
                    ...
                    details:
                        "The templateUrl parameter must be provided in the request body",
        ...
        if (!minScore) {
            context.res = {
                ...
                body: {
                    ...
                    type: "validation_error",
                    details:
                        "The minScore parameter must be provided in the request body",
                    timestamp: new Date().toISOString(),
                },
            };
            return;
        ...
        context.log(
            `OSSF validation completed for ${templateUrl} with local run ID: ${runId}: ${JSON.stringify(context.res.body)}`,
        );
    } catch (err) {
