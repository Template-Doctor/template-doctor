...
# Generated by full-setup-improved.sh on $(date)
###################################################################################################
...
# Database
$(if [[ -n "$MONGODB_URI" ]]; then echo "MONGODB_URI=$MONGODB_URI"; else echo "# MONGODB_URI - Leave unset for local dev (docker-compose default)"; fi)
