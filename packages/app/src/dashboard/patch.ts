...
(function(){
  ...
  if(typeof original.render !== 'function'){ return; }
  ...
  (window as any).DashboardRenderer.render = function(result, container){
    ...
    } catch(e){ console.error('[dashboard-patch] original render failed', e); }
    ...
    } catch(e){ console.error('[dashboard-patch] overview replacement failed', e); }
  };
})();
