...
router.post('/validation-template', async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    if (!targetRepoUrl || typeof targetRepoUrl !== 'string' || !/^https?:\/\//i.test(targetRepoUrl)) {
    ...
    console.log('validation-template dispatch', { requestId, ghUrl, branch, workflowFile });
    ...
    console.error('validation-template exception', { requestId, error: err?.message });
    next(err);
  }
});
...
router.post('/validation-docker-image', async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    console.log('validation-docker-image dispatch', { requestId, ghUrl, branch, workflowFile });
    ...
    console.error('validation-docker-image exception', { requestId, error: err?.message });
    next(err);
  }
});
...
router.post('/validation-ossf', async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    console.log('validation-ossf dispatch', { requestId, ghUrl, branch, workflowFile });
    ...
    console.error('validation-ossf exception', { requestId, error: err?.message });
    next(err);
  }
});
...
router.get('/validation-status', async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    console.error('validation-status exception', { requestId, error: err?.message });
    next(err);
  }
});
...
router.post('/validation-cancel', async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    console.log('validation-cancel request', { requestId, ghUrl, runId });
    ...
    console.error('validation-cancel exception', { requestId, error: err?.message });
    next(err);
  }
});
...
router.post('/validation-callback', async (req: Request, res: Response, next: NextFunction) => {
  ...
  try {
    ...
    console.error('validation-callback exception', { requestId, error: err?.message });
    next(err);
  }
});
