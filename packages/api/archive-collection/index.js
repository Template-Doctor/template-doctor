...
module.exports = async function (context, req) {
    ...
    try {
        ...
        const refRes = await fetch(
            `https://api.github.com/repos/${repoSlug}/git/ref/${baseRef}`,
            {
                headers: {
        ...
        if (!refRes.ok) {
            ...
            context.res = {
                ...
                headers,
                body: { error: "Failed to get base ref", details: err },
            };
            return;
        }
        ...
        if (!createRefRes.ok) {
            ...
            context.res = {
                ...
                headers,
                body: { error: "Failed to create branch", details: err },
            };
            return;
        }
        ...
        const putRes = await fetch(
            `https://api.github.com/repos/${repoSlug}/contents/${encodeURIComponent(archivePath)}`,
            {
                method: "PUT",
                headers: {
                    Authorization: `token ${token}`,
        ...
        if (!putRes.ok) {
            ...
            context.res = {
                ...
                headers,
                body: { error: "Failed to create content", details: err },
            };
            return;
        }
        ...
        if (!prRes.ok) {
            ...
            context.res = {
                status: prRes.status,
                headers,
                body: { error: "Failed to create PR", details: err },
            };
            return;
        }
